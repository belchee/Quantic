...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-100 text-gray-900 border-t border-gray-300">
      <div className="max-w-7xl mx-auto px-5 lg:px-8 py-16">
        ...
        <div className="mt-14 pt-8 border-t border-gray-300 flex flex-col sm:flex-row items-center justify-between gap-4">
