...
const t = {
  sq: {
    ...
    products_sub: "Shitës partner i Tiandy dhe TVT në Kosovë.",
    hero_partner_seller: "Shitës partner i Tiandy dhe TVT në Kosovë.",
  ...
  en: {
    ...
    products_sub: "Partner seller of Tiandy and TVT in Kosovo.",
    hero_partner_seller: "Partner seller of Tiandy and TVT in Kosovo.",
